...
tags: [idővonal, rstat, vistime]
---

Az R Studio-val könnyen készíthető idővonal (timeline) a `vistime` csomaggal.. A lehetőségekről lásd ezt: [StackOverflow](https://stackoverflow.com/questions/44265512/creating-a-timeline-in-r). Futtatható kódrészrel:
...
Az erdmény elmenthető `html` formátumban, illetve könnyedén publikálható az [Rpubs](http://rpubs.com/ZGFabian/514062) oldalakon. Hasonlóan hasznos a [timevis](https://daattali.com/shiny/timevis-demo/) csomag.
