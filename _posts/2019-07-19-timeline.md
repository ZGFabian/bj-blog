...
Az R Studioval könnyen készíthető idővonal (timeline) a `vistime` csomaggal.. A lehetőségekről lásd ezt a témát a [StackOverflow]-on(https://stackoverflow.com/questions/44265512/creating-a-timeline-in-r). Futtatható kódrészlet:
